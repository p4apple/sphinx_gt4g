//
// $Id: searchd.cpp 4821 2014-09-26 17:59:01Z shodan $
//
			...
			case SPH_ATTR_JSON:
				{
					...
					SphOffset_t uOffset = tMatch.GetAttr(tLoc);
					if ( uOffset )
					{
						assert ( pStrings );
